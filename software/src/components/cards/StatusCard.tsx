...
export default function StatusCard({ isSafe }: { isSafe: boolean }) {
  ...
  return (
    <div 
        ...
        className={`mt-6 mb-8 w-full h-48 relative shadow-[0px_4px_10px_0px_rgba(0,0,0,0.20)] absolute bg-gradient-to-l ${isSafe ? 'from-text-secondary to-secondary-navy' : 'from-secondary-light to-primary-light'} rounded-[10px]`}
    >
